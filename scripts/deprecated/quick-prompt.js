/* [Deprecated] - Script is fun, but can be a bit hit or miss 
Use the new prompt-anywhere.js script instead, it's much more reliable and has more features
...
// Name: Quick Prompt
// Description: Generate a quick prompt response in anywhere you can type
// Author: Josh Mabry
// Twitter: @AI_Citizen
// Shortcut:
...
const limiter = new Bottleneck({
  maxConcurrent: 1,
  // if you start seeing words jumble up set this higher
  minTime: 150,
});
